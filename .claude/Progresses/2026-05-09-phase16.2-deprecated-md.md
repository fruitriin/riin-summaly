...
Plan: [docs/plans/phase16.2-deprecated-md.md](../docs/plans/phase16.2-deprecated-md.md)

#### 実装

- [x] Step 1: `DEPRECATED.md` 新規作成 (ルート直下、4 機能の移行ガイド)
- [x] Step 2.1: README.md L45 の「HTTP エンドポイント廃止」削除
- [x] Step 2.2: README.md L48 / L114 phase14 言及を簡素化
- [x] Step 2.3: docs/Library.md L94 / L115 の廃止経緯削除
- [x] Step 2.4: docs/SETUP.md L90 / L208 / L443 / L547 の廃止経緯簡素化 + deploy-examples/README.md L79 同様
- [x] Step 2.5: docs/Plugins.md L258 / L272 の forceX 廃止経緯削除
- [x] Step 3: README.md 設計ドキュメントセクションに DEPRECATED.md リンク追加

#### 品質ゲート

- [x] Step 4.1: `pnpm build` / `pnpm eslint` / `pnpm typecheck` / `pnpm test` (584 件 pass)
- [x] Step 4.2: リンク切れチェック — 全 12 リンク先存在確認
- [x] Step 4.3: 廃止経緯の残存確認 — 「廃止」言及はすべて DEPRECATED.md リンク経由のみ
- [x] Step 4.4: 4.5 ドキュメント突き合わせ完了
- [x] Step 4.5: addf-code-review-agent — Critical 0 / Warning 3 (検証済み実害なし) / Info 3 のうち I-1 + I-2 反映
- [x] Step 4.6: addf-contribution-agent — skip (`.claude/` `templates/` `docs/knowhow/ADDF/` 不変更でフレームワーク無関係)
- [x] Step 4.7: CHANGELOG / TODO 更新 + Plan 完了状況追記
- [ ] Step 4.8: アーカイブ + コミット
