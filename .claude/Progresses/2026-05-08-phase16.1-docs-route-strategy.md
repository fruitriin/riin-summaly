...
Plan: [docs/plans/phase16.1-docs-route-strategy.md](../docs/plans/phase16.1-docs-route-strategy.md)

#### 実装

- [x] Step 1.1: README.md に「経路優先システム」セクション新設
- [x] Step 1.2: README.md 運用機能表に 3 行追加
- [x] Step 1.3: README.md 比較表に 3 行追加
- [x] Step 1.4: README.md プラグイン表に kakuyomu + 経路列
- [x] Step 1.5: README.md dev サーバセクション拡張
- [x] Step 2: docs/Library.md L94 文言更新
- [x] Step 3: docs/SETUP.md 経路優先システム俯瞰追加
- [x] Step 4: test/readme-plugins.test.ts 追加

#### 品質ゲート

- [x] Step 5.1: `pnpm build`
- [x] Step 5.2: `pnpm eslint`
- [x] Step 5.3: `pnpm typecheck`
- [x] Step 5.4: `pnpm test` (584 件 + ADDF tests pass)
- [x] Step 5.5: 4.5 ドキュメント突き合わせ (README / Library / SETUP / Plugins / config example 整合確認)
- [x] Step 5.6: addf-code-review-agent (Warning 3 件 + Suggestion 1 件すべて反映済)
- [x] Step 5.7: addf-contribution-agent — skip (`.claude/` `docs/knowhow/ADDF/` `templates/` 不変更でフレームワーク機能無関係)
- [x] Step 5.8: 知見記録 + CHANGELOG / TODO.md 更新 + Plan 完了状況追記
- [ ] Step 5.9: アーカイブ + コミット
