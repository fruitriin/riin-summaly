...
## 現在のフェーズ: phase1.2（次に着手）

## バックログ

| 優先度 | Phase | 計画ファイル | サイズ | 状態 |
|---|---|---|:---:|---|
| 1 | 1.2 | [docs/plans/phase1.2-options-mutation-fix.md](docs/plans/phase1.2-options-mutation-fix.md) — `summaly()` の opts mutation バグ修正（phase1.1 のテスト中に発見） | XS | 未着手 |
